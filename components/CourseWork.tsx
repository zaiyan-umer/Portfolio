            ...
            <PanelContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 select-none mt-4 py-6">
                    ...
                    {certifications.map((certification, idx) => (
                        <BorderCard key={idx} className="p-4 rounded-md border bg-muted/30 space-y-3 h-76">
                            ...
                            {/* Credential ID — now has a muted bg pill */}
                            ...
                            {/* Link — now has an arrow icon */}
                            <Link
                                href={certification.link}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group absolute bottom-0  inline-flex items-center gap-1 text-sm underline underline-offset-2 text-muted-foreground hover:text-foreground transition-colors"
                            >
                                View Certificate
                                <svg
